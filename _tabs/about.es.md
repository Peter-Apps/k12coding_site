...
- **\*\*utilizar software y lenguajes de nivel profesional\*\*** para que los estudiantes puedan continuar desarrollando sus experiencias a lo largo de la universidad y su carrera profesional

- **\*\*aumentar la equidad y el acceso\*\*** llegando a los estudiantes a través de las asignaturas troncales con actividades diseñadas para enseñar primero ciencias, utilizando la programación como herramienta

- **\*\*facilitar la implementación\*\*** mediante el uso de software intuitivo y gratuito y actividades completamente editables, diseñadas para docentes sin experiencia previa en programación
...
Para 2017, Adam dirigía un equipo de estudiantes universitarios y docentes que desarrollaba actividades para estudiantes del condado de Seminole, uno de los líderes en educación científica de Florida. También desarrollamos actividades sobre física de partículas que se han convertido en parte fundamental del programa [Quarknet]([https://quarknet.org/](https://quarknet.org/)), concretamente de su taller residencial para docentes, Data Camp, que se celebra cada verano en Fermilab. Poco después, llegó un anuncio del noveno distrito escolar más grande del país, con más de 13.000 estudiantes por nivel:

> “… los estudiantes tendrán una experiencia significativa con la programación en el lenguaje Python mediante la enseñanza tradicional de las ciencias.” - Superintendente de Orange County Public Schools, FL
...
Los datos científicos públicos no podrían incorporarse a nuestras actividades sin un equipo que los busque minuciosamente en la web y luego los depure, reformatee, documente, cite y finalmente organice en un cuaderno de Jupyter accesible para el público estudiantil al que están dirigidos. Gran parte de este trabajo fue realizado por estudiantes de la University of Central Florida, ya fuera como voluntarios o con remuneración de distritos escolares de la zona para ayudar a crear actividades específicas para determinados estándares educativos. Nuestro enorme agradecimiento a Megan Cox, Abryana Fergus, Kaitlyn Fisher, Lissa Galguera, Lauren Gandy, Samantha Marginean, Allison Mignardi, Steven Nguyen, Andrew Pepper, James D. Rivers, Paola Santiago-Crespo, Zacchaeus Scheffer, Dylan Skelly, Hunter T., Mitchell Todd, Tyler Townsend y Carolynn Turneur. Los docentes de secundaria de Quarknet Peter Apps (York Middle/High School, NY) y Jeremy Smith (Herford, MD), así como Michael Smith, graduado de Ciencias de la Computación de UCF, también contribuyeron desarrollando y mejorando varias actividades.
...
Si te gustaría contar con actividades adaptadas a tus necesidades o estás interesado en un uso comercial o propietario, estaremos encantados de desarrollar recursos para tu organización. Envía tus consultas a <adamlamee@gmail.com>.